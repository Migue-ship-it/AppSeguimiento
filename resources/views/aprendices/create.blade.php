...
<option value="4">Permiso por Protección Temporal (PPT)</option>
<option value="5">Permiso Especial de Permanencia (PPE)</option>
<br><br>
<label>No. de documento:</label>
<input type="number" name="Ndoc" id="Ndoc" required>
<br><br>
<label>Nombres:</label>
<input type="text" name="nombres" id="nombres" placeholder="Nombres completos del aprendiz" required>
<br><br>
<label>Apellidos:</label>
<input type="text" name="apellidos" id="apellidos" placeholder="Apellidos del aprendiz" required>
<br><br>
...
<input type="text" name="correoinstitucional" id="correoinstitucional" placeholder="aprendiz@soy.sena.edu.co" required>
<br><br>
